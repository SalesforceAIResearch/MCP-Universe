...
async def verify_music_report(_x: dict, *_args, **kwargs) -> Tuple[bool, str]:
    ...
    """
    from mcpuniverse.benchmark.mcpmark.evaluators.filesystem.desktop.music_report.verify import verify
...
async def verify_project_management(_x: dict, *_args, **kwargs) -> Tuple[bool, str]:
    ...
    """
    from mcpuniverse.benchmark.mcpmark.evaluators.filesystem.desktop.project_management.verify import verify
...
async def verify_timeline_extraction(_x: dict, *_args, **kwargs) -> Tuple[bool, str]:
    ...
    """
    from mcpuniverse.benchmark.mcpmark.evaluators.filesystem.desktop.timeline_extraction.verify import verify
...
async def verify_budget_computation(_x: dict, *_args, **kwargs) -> Tuple[bool, str]:
    ...
    """
    from mcpuniverse.benchmark.mcpmark.evaluators.filesystem.desktop_template.budget_computation.verify import verify
...
async def verify_contact_information(_x: dict, *_args, **kwargs) -> Tuple[bool, str]:
    ...
    """
    from mcpuniverse.benchmark.mcpmark.evaluators.filesystem.desktop_template.contact_information.verify import verify
...
async def verify_file_arrangement(_x: dict, *_args, **kwargs) -> Tuple[bool, str]:
    ...
    """
    from mcpuniverse.benchmark.mcpmark.evaluators.filesystem.desktop_template.file_arrangement.verify import verify
...
async def verify_duplicates_searching(_x: dict, *_args, **kwargs) -> Tuple[bool, str]:
    ...
    """
    from mcpuniverse.benchmark.mcpmark.evaluators.filesystem.file_context.duplicates_searching.verify import verify
...
async def verify_file_merging(_x: dict, *_args, **kwargs) -> Tuple[bool, str]:
    ...
    """
    from mcpuniverse.benchmark.mcpmark.evaluators.filesystem.file_context.file_merging.verify import verify
...
async def verify_file_splitting(_x: dict, *_args, **kwargs) -> Tuple[bool, str]:
    ...
    """
    from mcpuniverse.benchmark.mcpmark.evaluators.filesystem.file_context.file_splitting.verify import verify
...
async def verify_pattern_matching(_x: dict, *_args, **kwargs) -> Tuple[bool, str]:
    ...
    """
    from mcpuniverse.benchmark.mcpmark.evaluators.filesystem.file_context.pattern_matching.verify import verify
...
async def verify_uppercase(_x: dict, *_args, **kwargs) -> Tuple[bool, str]:
    ...
    """
    from mcpuniverse.benchmark.mcpmark.evaluators.filesystem.file_context.uppercase.verify import verify
...
async def verify_size_classification(_x: dict, *_args, **kwargs) -> Tuple[bool, str]:
    ...
    """
    from mcpuniverse.benchmark.mcpmark.evaluators.filesystem.file_property.size_classification.verify import verify
...
async def verify_time_classification(_x: dict, *_args, **kwargs) -> Tuple[bool, str]:
    ...
    - Total file count is correct
    """
    from mcpuniverse.benchmark.mcpmark.evaluators.filesystem.file_property.time_classification.verify import verify
...
async def verify_structure_analysis(_x: dict, *_args, **kwargs) -> Tuple[bool, str]:
    ...
    """
    from mcpuniverse.benchmark.mcpmark.evaluators.filesystem.folder_structure.structure_analysis.verify import verify
...
async def verify_structure_mirror(_x: dict, *_args, **kwargs) -> Tuple[bool, str]:
    ...
    """
    from mcpuniverse.benchmark.mcpmark.evaluators.filesystem.folder_structure.structure_mirror.verify import verify
...
async def verify_dispute_review(_x: dict, *_args, **kwargs) -> Tuple[bool, str]:
    ...
    """
    from mcpuniverse.benchmark.mcpmark.evaluators.filesystem.legal_document.dispute_review.verify import verify
...
async def verify_individual_comments(_x: dict, *_args, **kwargs) -> Tuple[bool, str]:
    ...
    """
    from mcpuniverse.benchmark.mcpmark.evaluators.filesystem.legal_document.individual_comments.verify import verify
...
async def verify_solution_tracing(_x: dict, *_args, **kwargs) -> Tuple[bool, str]:
    ...
    """
    from mcpuniverse.benchmark.mcpmark.evaluators.filesystem.legal_document.solution_tracing.verify import verify
...
async def verify_author_folders(_x: dict, *_args, **kwargs) -> Tuple[bool, str]:
    ...
    """
    from mcpuniverse.benchmark.mcpmark.evaluators.filesystem.papers.author_folders.verify import verify
...
async def verify_find_math_paper(_x: dict, *_args, **kwargs) -> Tuple[bool, str]:
    ...
    """
    from mcpuniverse.benchmark.mcpmark.evaluators.filesystem.papers.find_math_paper.verify import verify
...
async def verify_organize_legacy_papers(_x: dict, *_args, **kwargs) -> Tuple[bool, str]:
    ...
    """
    from mcpuniverse.benchmark.mcpmark.evaluators.filesystem.papers.organize_legacy_papers.verify import verify
...
async def verify_duplicate_name(_x: dict, *_args, **kwargs) -> Tuple[bool, str]:
    ...
    """
    from mcpuniverse.benchmark.mcpmark.evaluators.filesystem.student_database.duplicate_name.verify import verify
...
async def verify_english_talent(_x: dict, *_args, **kwargs) -> Tuple[bool, str]:
    ...
    """
    from mcpuniverse.benchmark.mcpmark.evaluators.filesystem.student_database.english_talent.verify import verify
...
async def verify_gradebased_score(_x: dict, *_args, **kwargs) -> Tuple[bool, str]:
    ...
    """
    from mcpuniverse.benchmark.mcpmark.evaluators.filesystem.student_database.gradebased_score.verify import verify
...
async def verify_code_locating(_x: dict, *_args, **kwargs) -> Tuple[bool, str]:
    ...
    """
    from mcpuniverse.benchmark.mcpmark.evaluators.filesystem.threestudio.code_locating.verify import verify
...
async def verify_output_analysis(_x: dict, *_args, **kwargs) -> Tuple[bool, str]:
    ...
    """
    from mcpuniverse.benchmark.mcpmark.evaluators.filesystem.threestudio.output_analysis.verify import verify
...
async def verify_requirements_completion(_x: dict, *_args, **kwargs) -> Tuple[bool, str]:
    ...
    """
    from mcpuniverse.benchmark.mcpmark.evaluators.filesystem.threestudio.requirements_completion.verify import verify
...
async def verify_dataset_comparison(_x: dict, *_args, **kwargs) -> Tuple[bool, str]:
    ...
    """
    from mcpuniverse.benchmark.mcpmark.evaluators.filesystem.votenet.dataset_comparison.verify import verify
...
async def verify_debugging(_x: dict, *_args, **kwargs) -> Tuple[bool, str]:
    ...
    """
    from mcpuniverse.benchmark.mcpmark.evaluators.filesystem.votenet.debugging.verify import verify
...
async def verify_requirements_writing(_x: dict, *_args, **kwargs) -> Tuple[bool, str]:
    ...
    - No duplicate entries
    """
    from mcpuniverse.benchmark.mcpmark.evaluators.filesystem.votenet.requirements_writing.verify import verify
